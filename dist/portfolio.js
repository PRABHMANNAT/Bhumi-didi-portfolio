...
const projectCards = [
  ...
  { category: 'AI / ML', project: 'speech', image: 'samsung.jpg', alt: 'Samsung PRISM certificate shared on LinkedIn', title: 'Spoken Language Identification', description: 'Samsung PRISM research across Hindi, Urdu and Punjabi focused on making speech AI more dependable in varied listening conditions. The project combined dataset preparation, feature-level analysis and model evaluation to compare language signals with care and consistency.', skills: 'NLP · Speech-data preparation · Feature analysis · Model evaluation' },
  { category: 'AI / ML', project: 'disease-risk-prediction', image: 'medical-disease-risk-prediction.png', alt: 'Medical disease risk prediction dashboard', title: 'Medical Disease Risk Prediction', description: 'A machine-learning exploration of diabetes and heart-disease risk indicators using structured health data. The work focused on preparing interpretable inputs, comparing predictive approaches and presenting early risk signals in a way that supports responsible review.', skills: 'Data preprocessing · Predictive modelling · Evaluation metrics · Data visualisation' },
  { category: 'AI / ML', title: 'Insight Copilot', description: 'A concept for an AI assistant that turns scattered feedback into searchable themes, priority signals and concise next steps. It is designed around human review—helping teams identify patterns without treating automation as a replacement for judgement.', skills: 'Text analysis · Prompt design · Insight synthesis · Human-in-the-loop UX', placeholder: 'AI / ML concept\nImage coming soon' },
  { category: 'Products', title: 'Student Opportunity Hub', description: 'A product concept that brings campus events, opportunities, clubs and resources into one personalised starting point. The experience is structured to help students discover what matters, save it for later and move from interest to participation with less friction.', skills: 'Product strategy · User journeys · Information architecture · Interaction design', placeholder: 'Product concept\nImage coming soon' },
  { category: 'Products', title: 'Client Delivery Portal', description: 'A client-facing product concept for turning a project brief into a transparent delivery journey. It brings goals, milestones, feedback and approvals into one shared workspace so every stakeholder can see what is happening and what needs attention next.', skills: 'Service design · Workflow mapping · Stakeholder UX · Product requirements', placeholder: 'Product concept\nImage coming soon' },
  ...
  { category: 'Automation', project: 'automation', image: 'night-code.jpg', alt: 'Editorial technology image', title: 'Operations Automation Studio', description: 'A practical automation initiative for mapping repetitive business work and turning it into connected, dependable flows. Each solution begins with the handoffs, follow-ups and information gaps that slow teams down, then moves toward a system people can actually use.', skills: 'Process mapping · Automation design · Requirements analysis · Workflow optimisation' },
  { category: 'Automation', title: 'Workflow Autopilot', description: 'A concept for a workflow layer that connects incoming requests, status updates and internal handovers in one visible sequence. The goal is to reduce manual chasing, clarify ownership and give teams a reliable view of what should happen next.', skills: 'Systems thinking · Workflow design · Operational analytics · Service blueprinting', placeholder: 'Automation concept\nImage coming soon' },
