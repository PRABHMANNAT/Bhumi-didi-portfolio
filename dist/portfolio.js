...
const projectCards = [
  ...
  { category: 'AI / ML', project: 'speech', role: 'AI Research Intern & Team Lead', title: 'Spoken Language Identification', description: 'At Samsung R&D Institute, Bangalore, I contributed to three Samsung PRISM worklets spanning Hindi, Urdu and Punjabi. My role covered speech-data preparation, experiment coordination and evaluation work focused on making language identification more dependable across varied listening conditions.', skills: 'NLP · Speech-data preparation · Feature analysis · Model evaluation', placeholder: 'AI / ML project\nImage coming soon' },
  { category: 'AI / ML', project: 'disease-risk-prediction', role: 'Machine-learning research contributor', title: 'Medical Disease Risk Prediction', description: 'Worked on a health-data modelling study for diabetes and heart-disease risk indicators. The project involved preparing structured inputs, exploring predictive approaches, interpreting evaluation metrics and shaping a responsible dashboard view that supports review rather than diagnosis.', skills: 'Data preprocessing · Feature engineering · Predictive modelling · Evaluation metrics · Data visualisation', placeholder: 'AI / ML project\nImage coming soon' },
