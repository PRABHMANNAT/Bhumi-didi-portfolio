...
const projectCards = [
  { category: 'Startups', project: 'virtual-labs', image: 'virtual-labs.svg', alt: 'Original interface concept illustration created for this portfolio', title: 'Virtual Simulation Labs', description: 'An EdTech concept that turns a learner’s question into a guided simulation. The experience is designed to make scientific exploration more visual, interactive and approachable for students.' },
  ...
  { category: 'Startups', title: 'Ingen Labs', description: 'A growing venture space for ideas at the intersection of technology, analysis and marketing. Project imagery and a fuller case study will be added here as the work is ready to share.', placeholder: 'Startup case study\nImage coming soon' },
